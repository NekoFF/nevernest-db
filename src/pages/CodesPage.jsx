...
export default function CodesPage({ topbarQuery = '' }) {
  ...
  return (
    <div className="relative space-y-7 pb-6">
      <Seo title="Codes" description="Track active and expired NTE redeem codes, rewards, and availability." />
          ...
          <div className="max-w-3xl space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-base leading-relaxed text-[#6b7280] sm:text-lg">
                Redeem active NTE codes, copy them instantly, and track expired rewards.
              </p>
            </div>
          </div>
          <SummaryCounters
