export default function StatItem({ icon: Icon, label, value, onClick }) {
  ...
  return (
    <Component
      ...
      onClick={onClick}
      className="surface-glass-soft group flex min-w-0 items-center gap-2 rounded-2xl px-2.5 py-3 text-left transition duration-200 hover:-translate-y-0.5 hover:border-[#ff2f6d]/12 hover:bg-white/86 hover:shadow-[0_14px_34px_rgba(0,0,0,0.07)] sm:gap-2.5 sm:px-3"
    >
