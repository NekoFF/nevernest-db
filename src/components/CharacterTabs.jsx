...
export default function CharacterTabs({ element, activeTab, onTabChange, children }) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[22px] border border-black/[0.06] bg-white/95 p-1.5 shadow-[0_16px_48px_rgba(0,0,0,0.05)] sm:p-2">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active ? `${accent.chip} shadow-sm ring-black/[0.06]` : 'text-[#6b7280] ring-transparent hover:bg-[#fafafa] hover:text-[#111111]',
                ].join(' ')}
              >
                {t.label}
              </button>
