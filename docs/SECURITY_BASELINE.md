...
- **Admin Writes:** Disabled by default. Active endpoints (`PATCH /api/admin/codes/:idOrSlug`, `PATCH /api/admin/news/:slug`) enabled only via `ENABLE_LOCAL_ADMIN_WRITES=1`. Isolated in dedicated admin routes module.
