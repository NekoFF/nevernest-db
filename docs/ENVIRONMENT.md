...
- Local default used by the client: `http://127.0.0.1:4000`.
...
- Omit it for the disabled/default route skeleton behavior.
...
- Safety guards reject production-looking URLs.
